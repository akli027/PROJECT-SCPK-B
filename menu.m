...
% Last Modified by GUIDE v2.5 30-Apr-2020 19:39:19
...
movegui(hObject,'center');%ketika buka berada ditengah
...
% handles    structure with handles and user data (see GUIDATA)
close;
guidata(Menukedua); %untuk pindah layout ke pengisian data
